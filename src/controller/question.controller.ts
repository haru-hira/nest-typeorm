...
export class QuestionController {
  ...
  async create(@Body() createUserDataDto: CreateQuestionDataDTO): Promise<Question> {
  ...
  async update(@Param('id') id: number, @Body() updateQuestionDataDto: UpdateQuestionDataDTO): Promise<void> {
